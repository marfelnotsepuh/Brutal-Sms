...
# [+]-------------------------------------------[+]
#  | Creator : [𝙈𝘿]./ FΣᄂ4YӨЦᄃӨDΣ444🕊️   		         |
#  | Github : https://github.com/marfelnotsepuh        |
...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}[𝙈𝘿]./ FΣᄂ4YӨЦᄃӨDΣ444🕊️            │ Version {R}:{G} 3.0{W}             │
  {W}│ Github{R}:{G}github.com/marfelnotsepuh {W}│ {W}Your Ip {R}:{Y} {ip}   {W}│
